...
> **Version**: v1.26.0 | **Bot**: Pattern 5m (27패턴, 9L+18S) | **Updated**: 2026-02-08
...
| Leverage | 3x |
| Timeframe | 5m |
| Quality Filter | WR-based: **WR >= 85%**, R:R-based: **MC<0.005, WF=5/5, R:R>=1.0** |

### 270일 종합 검증 결과

| 지표 | v1.26.0 |
|------|---------|
| Patterns | **27 (9L+18S)** — 23 WR-based + 4 R:R-based |
| WR-based | 23패턴, WR 90.4%, PnL +898.5% (v1.25.4 base) |
| R:R-based | 4패턴, Avg Exp +2.21%/trade, R:R 1.0~2.14 |
| Research | tp_ge_sl_research_v3 (2026-02-08) |

### LONG Patterns (9) — v1.26.0 (6 WR + 3 R:R)
...
| **BU-IH-DN** | 1.5/1.0 | 69.2% | 0.0039 | 5/5 | 26 | R:R=1.50, Exp +2.09% |
| **MU-H-MU** | 1.5/0.7 | 60.7% | 0.0047 | 5/5 | 28 | R:R=2.14, Exp +1.81% |
| **MD-MD-ST** | 1.0/1.0 | 71.8% | 0.0049 | 5/5 | 39 | R:R=1.00, Exp +1.21% |

> v1.26.0 추가: BU-IH-DN, MU-H-MU, MD-MD-ST — v3 R:R 연구 (MC<0.005, WF=5/5, Per=3/3)

### SHORT Patterns (18) — v1.26.0 (17 WR + 1 R:R)
...
| **BU-MU-DN** | 2.5/2.0 | 72.7% | 0.0002 | 5/5 | 44 | R:R=1.25, Exp +3.72% |

> **★ TOP**: DN-U-U — 최고 PnL 기여 (+115.1%)
> v1.26.0 추가: BU-MU-DN — v3 R:R 연구 (MC<0.005, WF=5/5, Per=3/3)
...
| 버전 | 날짜 | 변경사항 |
|------|------|---------|
| **v1.26.0** | 02-08 | v3 R:R 연구 → 4패턴 추가 (27=23+4), R:R>=1.0 포트폴리오 확장 ← **현재** |
