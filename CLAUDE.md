...
> **Version**: v1.48.0 | **Bot**: Pattern 5m (130패턴, 61L+69S, Edge18pp+NeutralWindow+ATR Scanner+Holdout+MDD+Cap7+MomentumGuard15m1h+NposScanner+CascadeSL85+AggRiskRelax+ATRClamp05+TO288) | **Updated**: 2026-03-05
...
| Risk | Daily loss **13%** (v1.28.5), **aggregate risk cap** (counter 5%/with 15%, v1.44.0 relaxed from 3/7) |
...
| **Aggregate Risk Cap (v1.35.5→v1.44.0)** | **방향별 SL 노출 합산 제한** — counter-regime **5%**, with-regime **15%** cap (v1.44.0: 3/7→5/15 완화. aggrisk_cascade_validation: Cascade-OFF에서도 PnL/MDD 2배 개선, 랜덤 0/15 PASS=판별력 확보, worst burst -3.63% ≈ baseline -3.30%) |
