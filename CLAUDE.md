...
> **Version**: v1.35.5 | **Bot**: Pattern 5m (51패턴, 16L+35S, ATR Scanner+Holdout+MDD+Cap8+AggRiskCap) | **Updated**: 2026-02-26
...
| Risk | Daily loss **13%** (v1.28.5), 3-consecutive-loss pause, **aggregate risk cap** (counter 3%/with 7%, v1.35.5) |
