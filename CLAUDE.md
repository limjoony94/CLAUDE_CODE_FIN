...
### LONG Patterns (32) — v1.27.0 Uniform TP 70%
...
| DN-MD-DN | 1.05/2.0 | 0.53 | 73.8% | 0.0099 | 4/3 | 184 |
...
| U-GS-DN | 2.1/3.0 | 0.70 | 87.5% | 0.0001 | 5/3 | 26 |
| U-H-BU | 0.7/0.3 | 2.33 | 47.6% | 0.0467 | 4/3 | 42 |
...
| 버전 | 날짜 | 변경사항 |
|------|------|---------|
| **v1.27.0** | 02-10 | Uniform TP 70% + 리스크 관리: TP×0.7 전체 적용, WR 83.7%, PnL +911.1%, MDD 16.2%, daily limit 7%, 연속손실 3회 pause + context filter 심층연구 FAIL (BH FDR 0/156 유의) ← **현재** |
