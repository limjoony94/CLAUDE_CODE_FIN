...
> **Version**: v1.33.0 | **Bot**: Pattern 5m (35패턴, 9L+26S, Compact TP/SL + Direction Cap 6) | **Updated**: 2026-02-23
...
| **v1.33.0** | 02-23 | **35pat Compact TP/SL + 15 STRONG SHORT 복원**: `short_restore_tpsl_compact_study.py` 6-Phase 연구. (1) 34 탈락 SHORT 중 15개 STRONG 복원 (4-Phase 재평가). (2) Compact grid (TP max 2.0%, SL max 2.5%) vs Wide 비교 — compact가 PnL/MDD 28.84 (wide 14.23), holding time 1.5-1.9x 빠름. (3) 35pat(9L+26S): trades 1343 (4.97/day), WR 68.1%, PnL +297.1%, MDD 10.3%, **WF 3/3 PASS**. TP 0.50-2.00%, SL 1.00-2.50%. EXPECTED_WR=68.1, EXPECTED_EDGE=0.221. Backup: `dynamic_patterns_22pat_wide_backup.json`. ← **현재** |
