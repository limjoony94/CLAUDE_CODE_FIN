...
Trains EXIT models specifically for Opportunity Gating entry strategy:
- LONG Entry: prob >= 0.65
- SHORT Entry: prob >= 0.70 + EV gating (EV_short > EV_long + 0.001)

Key Difference from Phase 4:
- Phase 4: Higher LONG threshold (0.70), lower SHORT threshold (0.65), no gating
- Opportunity Gating: Lower LONG threshold (0.65), higher SHORT threshold (0.70), WITH gating
- Result: Very different trade frequency and patterns

Exit model must be trained on same entry strategy to be effective.
...
ENTRY_THRESHOLD_LONG = 0.65  # Lower than Phase 4 (0.70)
ENTRY_THRESHOLD_SHORT = 0.70  # Higher than Phase 4 (0.65)
...
def load_entry_models():
    ...
    # LONG Entry (LATEST: Enhanced with 5-fold CV - 2025-10-24)
    ...
    # SHORT Entry (LATEST: Enhanced with 5-fold CV - 2025-10-24)
    ...
    print("✅ ENTRY models loaded (Enhanced 2025-10-24)")
...
# Last synced: 2025-11-03 from retrain_exit_models_opportunity_gating.py
# Provides: prepare_exit_features() - 25 exit features
# ===================================
