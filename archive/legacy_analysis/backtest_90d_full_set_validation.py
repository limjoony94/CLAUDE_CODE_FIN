"""
Backtest 90-Day Model Set (FULL SET - LONG + SHORT both 90-day)
================================================================

Purpose: Validate 90-day trade outcome models as complete set
         (NOT hybrid - all 4 models from same training period)
...
Validation Period: Sep 29 - Oct 26, 2025 (same as fair comparison)
...
# Models (90-day Entry + 52-day Exit)
MODEL_LONG = MODELS_DIR / "xgboost_long_entry_90days_tradeoutcome_20251106_193900.pkl"
MODEL_SHORT = MODELS_DIR / "xgboost_short_entry_90days_tradeoutcome_20251106_193900.pkl"
...
SCALER_SHORT = MODELS_DIR / "xgboost_short_entry_90days_tradeoutcome_20251106_193900_scaler.pkl"
...
FEATURES_SHORT = MODELS_DIR / "xgboost_short_entry_90days_tradeoutcome_20251106_193900_features.txt"
...
print("=" * 80)
print("BACKTEST: 90-DAY MODEL SET (FULL SET - NOT HYBRID)")
print("=" * 80)
print()
print(f"📊 Configuration:")
print(f"   Entry Models: 90-day trade outcome (20251106_193900)")
...
if len(trades_df) > 0:
    ...
    output_file = RESULTS_DIR / f"backtest_90d_full_set_{timestamp_str}.csv"
