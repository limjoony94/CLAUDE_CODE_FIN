"""
Backtest with Production Settings - Recent 5 Days
================================================
...
Date Range: Last 5 days (2025-10-19 to 2025-10-24)
"""
...
# Entry Thresholds
LONG_THRESHOLD = 0.80  # TESTING
SHORT_THRESHOLD = 0.80  # TESTING
...
print("=" * 80)
print("BACKTEST: PRODUCTION SETTINGS - RECENT 5 DAYS")
print("=" * 80)
...
# Filter to recent 5 days (2025-10-19 to 2025-10-24)
end_date = pd.Timestamp('2025-10-24')
start_date = end_date - timedelta(days=5)

df_recent = df[(df['timestamp'] >= start_date) & (df['timestamp'] < end_date)].copy()
...
if trades:
    ...
    # Save results
    output_file = PROJECT_ROOT / "results" / f"backtest_production_5days_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
