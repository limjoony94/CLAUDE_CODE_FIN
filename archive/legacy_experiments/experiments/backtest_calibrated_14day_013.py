...
print("="*80)
print("BACKTEST: CALIBRATED 14-DAY 0.13 - TARGET 4.0 TRADES/DAY")
print("="*80)
print()
...
# Results
print("\n" + "="*80)
print("RESULTS - CALIBRATED 14-DAY 0.13")
print("="*80)
...
if trades:
    ...
    output_file = RESULTS_DIR / f"backtest_retrained_calibrated_14day_013_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
