"""
Backtest Oct 9-13: Production Trade-Outcome Models
====================================================

Test production models (29.06% return, 85.3% win rate) on Oct 9-13 period.
...
print("="*80)
print("BACKTEST OCT 9-13: PRODUCTION TRADE-OUTCOME MODELS")
print("="*80)
print(f"\nPeriod: 2025-10-09 to 2025-10-13 (5 days)")
...
# Filter Oct 9-13 period
print("\nFiltering Oct 9-13 period...")
df_period = df_full[
    (df_full['timestamp'] >= '2025-10-09') &
    (df_full['timestamp'] < '2025-10-14')
].copy()

print(f"  Oct 9-13 candles: {len(df_period):,}")
if len(df_period) > 0:
    ...
    print("\n❌ No data found for Oct 9-13 period!")
    sys.exit(1)
...
# Filter features for Oct 9-13
df_test = df[
    (df['timestamp'] >= '2025-10-09') &
...
# =============================================================================
print("\n" + "="*80)
print("BACKTEST RESULTS: OCT 9-13 (5 DAYS)")
print("="*80)
