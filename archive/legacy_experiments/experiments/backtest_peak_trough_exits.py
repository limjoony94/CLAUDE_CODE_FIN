...
print("=" * 80)
print("BACKTEST - PEAK/TROUGH EXIT MODELS")
print("=" * 80)
print()
...
long_exit_path = MODELS_DIR / "xgboost_long_exit_peak_trough_20251030_213509.pkl"
long_exit_scaler_path = MODELS_DIR / "xgboost_long_exit_peak_trough_20251030_213509_scaler.pkl"
long_exit_features_path = MODELS_DIR / "xgboost_long_exit_peak_trough_20251030_213509_features.txt"

# SHORT Exit: Fold 2 (F1: 0.8301) - BEST with 21 features
short_exit_path = MODELS_DIR / "xgboost_short_exit_peak_trough_20251030_213509.pkl"
short_exit_scaler_path = MODELS_DIR / "xgboost_short_exit_peak_trough_20251030_213509_scaler.pkl"
short_exit_features_path = MODELS_DIR / "xgboost_short_exit_peak_trough_20251030_213509_features.txt"
...
for idx in range(100, len(df)):
    ...
    if position is not None:
        ...
        # ML Exit (PEAK/TROUGH EXIT MODELS)
        else:
...
# Results
print("=" * 80)
print("BACKTEST RESULTS - PEAK/TROUGH EXIT MODELS")
print("=" * 80)
print()
...
results_file = RESULTS_DIR / f"peak_trough_exits_backtest_{timestamp}.csv"
