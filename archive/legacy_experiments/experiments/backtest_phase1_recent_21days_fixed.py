"""
Backtest Phase 1 Models on Recent 21 Days
=========================================
...
Test Period: Last 21 days (within Holdout period)
  Oct 6 - Oct 26 (6,048 candles)

Success Criteria:
  - Return > 0%
  - Win Rate > 60%
  - Trade frequency ≥ 1.5/day
  - Total trades ≥ 20
...
print("="*80)
print("BACKTEST: PHASE 1 - RECENT 21 DAYS VALIDATION")
print("="*80)
print()
print("Models:")
...
# Analyze Results
print("\n" + "="*80)
print("RECENT 21-DAY BACKTEST RESULTS")
print("="*80)
