"""
Backtest RETRAINED Models on 14-Day Holdout
==========================================

Models Under Test:
  Entry: RETRAINED with Latest Data (timestamp: 20251029_081454)
    - Training: Jul 14 - Oct 12 (90 days)
    - LONG: 80 features, 27.96% positive (Fold 5)
    - SHORT: 79 features, 7.37% positive (Fold 5)

  Exit: Full features (existing, threshold 0.75)
    - LONG: 21 features
    - SHORT: 21 features

Test Period: 14-day Holdout (NOT seen during training)
  Oct 13 - Oct 26 (4,032 candles)

Success Criteria:
  - Return > 0%
  - Trade frequency > 2.0/day
  - Total trades > 28 (14 days)
  - Win rate > 65%
...
print("="*80)
print("BACKTEST: RETRAINED MODELS - 14-DAY HOLDOUT VALIDATION")
print("="*80)
print()
print("Models:")
print("  Entry: RETRAINED with Latest Data (20251029_081454)")
print("    - Training: Jul 14 - Oct 12 (90 days)")
print("    - LONG: 80 features (27.96% positive, Fold 5)")
print("    - SHORT: 79 features (7.37% positive, Fold 5)")
print("  Exit: Full features (threshold 0.75)")
print("    - LONG/SHORT: 21 features each")
print()
...
# Entry Models (RETRAINED with Latest Data)
...
print(f"✅ Entry Models (RETRAINED 20251029_081454):")
...
# Analyze Results
print("\n" + "="*80)
print("HOLDOUT BACKTEST RESULTS (14 DAYS)")
print("="*80)
...
if trades:
    ...
    # Save results
    output_file = RESULTS_DIR / f"backtest_retrained_14day_holdout_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
    ...
    print(f"\n1. Trade Frequency: {trade_freq:.2f}/day (target: ≥2.0)")
    if trade_freq >= 2.0:
        print("   ✅ PASS")
    else:
        print(f"   ❌ FAIL (-{2.0-trade_freq:.2f} trades/day short)")

    print(f"\n2. Total Trades: {len(df_trades)} (target: ≥28)")
    if len(df_trades) >= 28:
        print("   ✅ PASS")
    else:
        print(f"   ❌ FAIL (-{28-len(df_trades)} trades short)")
...
print("  LONG: 27.96% positive (Fold 5)")
print("  SHORT: 7.37% positive (Fold 5)")
print()
if trades:
