"""
Retrain Entry Models - Walk-Forward Ensemble (Top-3 Weighted)
===============================================================

Saves ALL 5 fold models for ensemble prediction instead of selecting best fold.

Improvements:
  - All fold models saved (not just best)
  - Validation scores saved for weighting
  - Top-3 Weighted Ensemble in production
...
print("="*80)
print("WALK-FORWARD ENSEMBLE TRAINING (TOP-3 WEIGHTED)")
print("="*80)
print()
print("Key Differences vs Best Fold:")
print("  ✅ Saves ALL 5 fold models (not just best)")
print("  ✅ Validation scores saved for weighting")
print("  ✅ Top-3 models used in production (weighted average)")
print()
