...
avg_body_20_arr = pd.Series(body_abs_arr).rolling(20, min_periods=1).mean().values
types = [classify_candle(opens[i], highs[i], lows[i], closes[i], avg_body_20_arr[i]) for i in range(n_bars)]
