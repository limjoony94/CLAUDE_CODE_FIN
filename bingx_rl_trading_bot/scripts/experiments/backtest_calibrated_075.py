...
print("="*80)
print("BACKTEST: CALIBRATED 0.75 - TARGET 4.0 TRADES/DAY")
print("="*80)
print()
...
if trades:
    ...
    output_file = RESULTS_DIR / f"backtest_retrained_calibrated_075_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
