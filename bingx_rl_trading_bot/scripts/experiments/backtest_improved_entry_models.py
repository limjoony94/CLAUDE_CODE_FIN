...
print("="*80)
print("BACKTEST: IMPROVED ENTRY MODELS (2-of-3 Labeling)")
print("="*80)
print(f"\n🔬 Testing IMPROVED Entry Models:")
print(f"   LONG: Precision 34.4% (vs 13.7% baseline)")
print(f"   SHORT: Improved 2-of-3 labeling")
print(f"   Expected: Less overtrading, better win rate\n")
...
# Load IMPROVED Entry models (2-of-3 labeling)
print("Loading IMPROVED Entry models...")
long_model_path = MODELS_DIR / "xgboost_long_improved_labeling_20251018_051817.pkl"
with open(long_model_path, 'rb') as f:
    long_model = pickle.load(f)

long_scaler_path = MODELS_DIR / "xgboost_long_improved_labeling_20251018_051817_scaler.pkl"
long_scaler = joblib.load(long_scaler_path)

long_features_path = MODELS_DIR / "xgboost_long_improved_labeling_20251018_051817_features.txt"
with open(long_features_path, 'r') as f:
    long_feature_columns = [line.strip() for line in f.readlines()]

short_model_path = MODELS_DIR / "xgboost_short_improved_labeling_20251018_051822.pkl"
with open(short_model_path, 'rb') as f:
    short_model = pickle.load(f)

short_scaler_path = MODELS_DIR / "xgboost_short_improved_labeling_20251018_051822_scaler.pkl"
short_scaler = joblib.load(short_scaler_path)

short_features_path = MODELS_DIR / "xgboost_short_improved_labeling_20251018_051822_features.txt"
with open(short_features_path, 'r') as f:
    short_feature_columns = [line.strip() for line in f.readlines()]

# Load Exit Models (RETRAINED for Opportunity Gating - 2025-10-17)
print("Loading Exit models (Opportunity Gating)...")
...
# Calculate features
print("Calculating ALL features (LONG + SHORT + EXIT)...")
...
if len(results_df) > 0:
    ...
    print(f"\n{'='*80}")
    print("IMPROVED ENTRY MODELS BACKTEST RESULTS (2-of-3 Labeling)")
    print(f"{'='*80}\n")
