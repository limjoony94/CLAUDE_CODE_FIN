#!/usr/bin/env python3
"""
Backtest Last 12 Hours - Signal Analysis
=========================================
Analyzes entry/exit signals for the last 12 hours of trading data.
Shows detailed signal information for each candle.

Usage:
    python scripts/experiments/backtest_last_12h.py
"""
...
LOOKBACK_HOURS = 12
CANDLE_INTERVAL = '5m'
INITIAL_BALANCE = 4843.42  # Current balance
...
def run_backtest(df, features, models):
    ...
    print("\n" + "="*100)
    print("📊 BACKTEST: LAST 12 HOURS - SIGNAL ANALYSIS")
    print("="*100)
...
def main():
    ...
    # Fetch data (last 12 hours + 1000 candles for features)
    print(f"📥 Fetching last 12 hours of data...")
    limit = 12 * 60 // 5 + 200  # 12 hours + buffer for features
    ...
    # Filter to last 12 hours for backtest
    backtest_start_idx = len(df) - (12 * 60 // 5)
    ...
    output_path = PROJECT_ROOT / 'results' / 'backtest_last_12h_signals.csv'
