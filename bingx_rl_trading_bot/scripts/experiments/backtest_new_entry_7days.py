"""
NEW Entry Models Backtest: 7-Day Test Period
==============================================

Tests NEW entry models with optimized exit on recent 7 days:
...
print("="*80)
print("PRODUCTION SETTINGS BACKTEST - 7 DAY TEST")
print("="*80)
print(f"\nTesting EXACT production configuration on recent 7 days\n")
...
# Multi-parameter grid search: +75.58% return, 63.6% WR, MDD -12.2%, Sharpe 0.336
ML_EXIT_THRESHOLD_LONG = 0.75  # OPTIMIZED (was 0.70)
ML_EXIT_THRESHOLD_SHORT = 0.75  # OPTIMIZED (was 0.72)
EMERGENCY_MAX_HOLD_TIME = 120  # 10 hours (120 candles × 5min) - OPTIMIZED (was 96)
EMERGENCY_STOP_LOSS = -0.03  # Balance-Based: -3% total balance (optimized)
...
print("Loading NEW Entry models (Enhanced with 5-fold CV - Oct 24)...")
...
# Load Exit Models (Enhanced - Oct 23)
print("Loading Exit models (Enhanced - Oct 23)...")
...
print("Calculating features (Enhanced v2 + phase1)...")
...
print("="*80)
print("7-DAY BACKTEST RESULTS - PRODUCTION SETTINGS")
print("="*80)
...
print(f"\n📊 Overall Performance:")
print(f"   Test Period: 7 days ({SEVEN_DAYS_CANDLES} candles)")
...
print(f"   Trades per Day: {total_trades/7:.1f}")
...
print(f"\n📊 Projections:")
print(f"   If this 7-day performance continues:")
print(f"   - Monthly Return: {((1 + return_pct/100) ** (30/days_tested) - 1) * 100:.1f}%")
...
print(f"\n" + "="*80)
print("7-DAY PRODUCTION VALIDATION COMPLETE")
print("="*80)
