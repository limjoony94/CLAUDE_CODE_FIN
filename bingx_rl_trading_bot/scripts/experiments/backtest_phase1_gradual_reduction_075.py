"""
Backtest Phase 1 Gradual Reduction Entry Models
===================================================================

Models Under Test:
  Entry: Phase 1 Gradual Reduction (Walk-Forward Decoupled, timestamp: 20251029_025625)
    - LONG: 80 features (reduced from 85, -5 features)
    - SHORT: 79 features (no change)
...
Success Criteria:
  ...
  - Total trades ≥ 2,000 (statistical validity)
  - Win rate: 70-75% (realistic range)
...
print("=" * 80)
print("BACKTEST: PHASE 1 GRADUAL REDUCTION")
print("=" * 80)
print()
print("Models:")
print("  Entry: Phase 1 Gradual Reduction (20251029_025625)")
print("    - LONG: 80 features (was 85, -5 features)")
print("    - SHORT: 79 features (no change)")
...
long_entry_model = joblib.load(MODELS_DIR / "xgboost_long_entry_walkforward_reduced_phase1_20251029_025625.pkl")
long_entry_scaler = joblib.load(MODELS_DIR / "xgboost_long_entry_walkforward_reduced_phase1_20251029_025625_scaler.pkl")
with open(MODELS_DIR / "xgboost_long_entry_walkforward_reduced_phase1_20251029_025625_features.txt", 'r') as f:
    long_entry_features = [line.strip() for line in f if line.strip()]

short_entry_model = joblib.load(MODELS_DIR / "xgboost_short_entry_walkforward_reduced_phase1_20251029_025625.pkl")
short_entry_scaler = joblib.load(MODELS_DIR / "xgboost_short_entry_walkforward_reduced_phase1_20251029_025625_scaler.pkl")
with open(MODELS_DIR / "xgboost_short_entry_walkforward_reduced_phase1_20251029_025625_features.txt", 'r') as f:
