"""
Backtest Phase 1 Models on Holdout Period (30 Days)
====================================================
...
print("="*80)
print("BACKTEST: PHASE 1 ORIGINAL METHOD - HOLDOUT VALIDATION (30 DAYS)")
print("="*80)
print()
print("Models:")
...
if trades:
    ...
    # Save results
    output_file = RESULTS_DIR / f"backtest_phase1_holdout_30days_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
