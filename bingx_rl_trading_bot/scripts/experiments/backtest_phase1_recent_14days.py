"""
Backtest Phase 1 Models on Recent 14 Days
==========================================

Purpose: Extended validation of Phase 1 performance on recent data
         (last 14 days of dataset for better statistical reliability)
...
Test Period: Last 14 days of dataset
  Expected: Oct 13 - Oct 26, 2025
...
print("="*80)
print("BACKTEST: PHASE 1 - EXTENDED 14-DAY VALIDATION")
print("="*80)
print()
print("Models:")
...
print("-"*80)
print("Loading Data and Selecting Recent 14 Days")
print("-"*80)
...
# Run Backtest
print("="*80)
print("RUNNING BACKTEST ON RECENT 14 DAYS")
print("="*80)
...
# Analyze Results
print("\n" + "="*80)
print("RECENT 14-DAY BACKTEST RESULTS (PHASE 1)")
print("="*80)
...
if trades:
    ...
    # Save results
    output_file = RESULTS_DIR / f"backtest_phase1_recent_14days_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
    df_trades.to_csv(output_file, index=False)
    print(f"\n✅ Results saved: {output_file}")

    # Success Criteria Evaluation
    print("\n" + "="*80)
    print("SUCCESS CRITERIA EVALUATION (14-DAY VALIDATION)")
    print("="*80)
    ...
    print(f"\n4. Total Trades: {len(df_trades)} (target: ≥ 20)")
    if len(df_trades) >= 20:
        print("   ✅ PASS (Statistical significance)")
        criteria_passed += 1
    else:
        print("   ⚠️  BORDERLINE (Small sample)")

    # Comparison with 30-day holdout and 7-day
    print("\n" + "="*80)
    print("MULTI-PERIOD COMPARISON")
    print("="*80)
    print()
    print("30-Day Holdout (Sep 26 - Oct 26):")
    print("  Return: +40.24%")
    print("  Win Rate: 79.7%")
    print("  Trade Frequency: 1.97/day")
    print("  Trades: 59")
    print()
    print(f"14-Day Recent (Oct 13 - Oct 26):")
    print(f"  Return: {total_return:+.2f}%")
    print(f"  Win Rate: {win_rate:.1f}%")
    print(f"  Trade Frequency: {trade_freq:.2f}/day")
    print(f"  Trades: {len(df_trades)}")
    print()
    print("7-Day Recent (Oct 19 - Oct 26):")
    print("  Return: -0.28%")
    print("  Win Rate: 0.0%")
    ...
    if criteria_passed >= 3:
        print("✅ 14-DAY VALIDATION: PASSED")
        print("   Phase 1 maintains good performance on extended recent period")
        print("   Ready for production deployment")
        print()
        print("Recommendation: DEPLOY Phase 1 models to production")
    elif criteria_passed >= 2:
        print("⚠️  14-DAY VALIDATION: BORDERLINE")
        print("   Performance acceptable but not strong")
        print("   Consider deploying with close monitoring")
        print()
        print("Recommendation: Deploy with Week 1 strict monitoring")
    else:
        print("❌ 14-DAY VALIDATION: FAILED")
        print("   Recent performance significantly weaker than holdout")
        print("   Additional analysis or model refinement recommended")
        print()
        print("Recommendation: Do NOT deploy - investigate further")

else:
    print("\n⚠️  No trades executed - threshold too high for recent data")
