"""
Backtest Phase 2 Models on Holdout Period (30 Days)
====================================================

Models Under Test:
  Entry: Phase 2 Walk-Forward Reduced (timestamp: 20251029_072939)
    - LONG: 72 features, 30.58% positive (Fold 4)
    - SHORT: 73 features, 32.83% positive (Fold 3)
...
Success Criteria:
  - Trade frequency ≥ 4.0 trades/day
  - Total trades ≥ 120 (30 days minimum)
  - Win rate: 60-75% (realistic range)
...
print("="*80)
print("BACKTEST: PHASE 2 AGGRESSIVE REDUCTION - HOLDOUT VALIDATION (30 DAYS)")
print("="*80)
print()
print("Models:")
print("  Entry: Phase 2 Walk-Forward Reduced (20251029_072939)")
print("    - LONG: 72 features (30.58% positive, Fold 4)")
print("    - SHORT: 73 features (32.83% positive, Fold 3)")
...
# Entry Models (Phase 2 Walk-Forward Reduced)
long_entry_model = joblib.load(MODELS_DIR / "xgboost_long_entry_walkforward_reduced_phase2_20251029_072939.pkl")
long_entry_scaler = joblib.load(MODELS_DIR / "xgboost_long_entry_walkforward_reduced_phase2_20251029_072939_scaler.pkl")
with open(MODELS_DIR / "xgboost_long_entry_walkforward_reduced_phase2_20251029_072939_features.txt", 'r') as f:
    long_entry_features = [line.strip() for line in f if line.strip()]

short_entry_model = joblib.load(MODELS_DIR / "xgboost_short_entry_walkforward_reduced_phase2_20251029_072939.pkl")
short_entry_scaler = joblib.load(MODELS_DIR / "xgboost_short_entry_walkforward_reduced_phase2_20251029_072939_scaler.pkl")
with open(MODELS_DIR / "xgboost_short_entry_walkforward_reduced_phase2_20251029_072939_features.txt", 'r') as f:
    short_entry_features = [line.strip() for line in f if line.strip()]

print(f"✅ Entry Models (Phase 2 Walk-Forward Reduced):")
...
# Analyze Results
print("\n" + "="*80)
print("HOLDOUT BACKTEST RESULTS (30 DAYS) - PHASE 2")
print("="*80)
...
if trades:
    ...
    # Save results
    output_file = RESULTS_DIR / f"backtest_phase2_holdout_30days_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
...
print("="*80)
print()
print("Training Positive Rates (Phase 2):")
print("  LONG: 30.58% (Fold 4)")
print("  SHORT: 32.83% (Fold 3)")
print()
if trades:
