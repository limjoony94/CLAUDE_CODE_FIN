"""
Production Settings Backtest: 30-Day Test Period (10x Leverage)
================================================================

Tests production configuration with 10x leverage on recent 30 days:
- Entry Models: Trade-Outcome Full Dataset (2025-10-18)
- Exit Models: Opportunity Gating (2025-10-17)
- 10x Leverage with Dynamic Sizing (20-95%)
- Opportunity Gating (gate = 0.001)

⚠️ WARNING: 10x leverage = 2.5x higher risk/reward vs 4x leverage
"""
