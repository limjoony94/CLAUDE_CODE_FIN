...
# Strategy Parameters
LEVERAGE = 4
LONG_THRESHOLD = 0.75  # ALIGNED 2025-10-27: Match training thresholds
SHORT_THRESHOLD = 0.75  # ALIGNED 2025-10-27: Match training thresholds
...
print("Loading Entry models (Specialized Walk-Forward Fixed - 20251027_235741)...")
import joblib
...
if len(results_df) > 0:
    ...
    # Save results
    output_file = RESULTS_DIR / f"full_backtest_SPECIALIZED_080_threshold_080_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
