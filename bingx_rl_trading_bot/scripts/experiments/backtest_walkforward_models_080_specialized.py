"""
Backtest Walk-Forward Specialized Entry Models (0.80/0.80)
===========================================================

Tests the new 0.80-threshold specialized Entry models with Exit models.
108-window backtest to validate Win Rate improvement.

Models:
- Entry: walkforward_080_20251027_235741 (SPECIALIZED for 0.80)
...
print("="*80)
print("BACKTEST: WALK-FORWARD SPECIALIZED ENTRY MODELS (0.80/0.80)")
print("="*80)
print()
...
# LONG Entry
with open(MODELS_DIR / "xgboost_long_entry_walkforward_080_20251027_235741.pkl", 'rb') as f:
    long_entry_model = pickle.load(f)
long_entry_scaler = joblib.load(MODELS_DIR / "xgboost_long_entry_walkforward_080_20251027_235741_scaler.pkl")
with open(MODELS_DIR / "xgboost_long_entry_walkforward_080_20251027_235741_features.txt", 'r') as f:
    long_entry_features = [line.strip() for line in f]

# SHORT Entry
with open(MODELS_DIR / "xgboost_short_entry_walkforward_080_20251027_235741.pkl", 'rb') as f:
    short_entry_model = pickle.load(f)
short_entry_scaler = joblib.load(MODELS_DIR / "xgboost_short_entry_walkforward_080_20251027_235741_scaler.pkl")
with open(MODELS_DIR / "xgboost_short_entry_walkforward_080_20251027_235741_features.txt", 'r') as f:
...
if overall_win_rate >= 0.50:
    ...
    print("  2. Update bot with new Entry models (walkforward_080_20251027_235741)")
