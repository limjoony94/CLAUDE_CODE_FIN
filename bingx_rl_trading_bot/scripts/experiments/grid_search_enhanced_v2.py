...
# Strategy Parameters
LEVERAGE = 4
LONG_THRESHOLD = 0.80  # UPDATED 2025-10-25: Full backtest for monitoring metrics
SHORT_THRESHOLD = 0.80  # UPDATED 2025-10-25: Full backtest for monitoring metrics
...
ML_EXIT_THRESHOLD_LONG = 0.80  # LONG exit threshold (ADJUSTED for option B test)
ML_EXIT_THRESHOLD_SHORT = 0.80  # SHORT exit threshold (ADJUSTED for option B test)
...
print("Loading Exit models (Retrained - 20251024_043527/044510)...")
