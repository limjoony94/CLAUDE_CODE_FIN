"""
Retrain with 80/20 Split - Walk-Forward Decoupled
==================================================

Proper validation approach:
  - Train: 80% (24,003 candles, Jul 14 - Oct 5)
    Includes both calm AND volatile market start

  - Validation: 20% (6,001 candles, Oct 5 - Oct 26)
    Mostly volatile market for realistic testing

Key Differences from Previous:
  ❌ Phase 2: Only trained on calm market (failed on volatile)
  ❌ Full Period: Trained on 100% (no validation data)
  ✅ 80/20 Split: Train on both regimes, validate on unseen volatile data

This allows proper backtest validation before production deployment.
...
print("="*80)
print("80/20 SPLIT WALK-FORWARD DECOUPLED TRAINING")
print("="*80)
print()
...
print()
print("Rationale:")
print("  ⚠️  Phase 2 failed: Only trained on calm market")
print("  ⚠️  Full Period problem: No validation data left")
print("  ✅ 80/20 Split: Train on both regimes, validate on unseen data")
print()
print("Methodology:")
...
# ==============================================================================
# STEP 5: Train Exit Models (Walk-Forward + 80% data)
# ==============================================================================

print("="*80)
print("STEP 5: Training Exit Models (Walk-Forward + 80% Split)")
print("="*80)
print()
...
# Save LONG Entry
long_entry_path = MODELS_DIR / f"xgboost_long_entry_8020split_{timestamp}.pkl"
...
# Save SHORT Entry
short_entry_path = MODELS_DIR / f"xgboost_short_entry_8020split_{timestamp}.pkl"
...
# Save LONG Exit
long_exit_path = MODELS_DIR / f"xgboost_long_exit_8020split_{timestamp}.pkl"
...
# Save SHORT Exit
short_exit_path = MODELS_DIR / f"xgboost_short_exit_8020split_{timestamp}.pkl"
