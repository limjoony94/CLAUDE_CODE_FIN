...
print("="*80)
print(f"RETRAIN ENTRY MODELS: TRADE-OUTCOME LABELING (SAMPLE: {SAMPLE_SIZE:,} candles)")
print("="*80)
print("\n⚡ Using sample data for quick validation")
print("   Full dataset retraining will be done separately with optimizations\n")
...
model_path_long = MODELS_DIR / f"xgboost_long_trade_outcome_sample_{timestamp}.pkl"
scaler_path_long = MODELS_DIR / f"xgboost_long_trade_outcome_sample_{timestamp}_scaler.pkl"
features_path_long = MODELS_DIR / f"xgboost_long_trade_outcome_sample_{timestamp}_features.txt"
metadata_path_long = MODELS_DIR / f"xgboost_long_trade_outcome_sample_{timestamp}_metadata.json"
...
metadata_long = {
    "labeling_method": "trade_outcome_2of3_SAMPLE",
...
if not missing_features:
    ...
    # Save model
    model_path_short = MODELS_DIR / f"xgboost_short_trade_outcome_sample_{timestamp}.pkl"
    scaler_path_short = MODELS_DIR / f"xgboost_short_trade_outcome_sample_{timestamp}_scaler.pkl"
    features_path_short = MODELS_DIR / f"xgboost_short_trade_outcome_sample_{timestamp}_features.txt"
    metadata_path_short = MODELS_DIR / f"xgboost_short_trade_outcome_sample_{timestamp}_metadata.json"
...
print("\n" + "="*80)
print(f"RETRAINING COMPLETE - TRADE-OUTCOME LABELING (SAMPLE: {SAMPLE_SIZE:,})")
print("="*80)
