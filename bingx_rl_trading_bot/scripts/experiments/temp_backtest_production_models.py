...
# FULLY OPTIMIZED 2025-10-22: Multi-parameter grid search (64 combinations)
# Performance: +75.58% return, 63.6% WR, MDD -12.2%, Sharpe 0.336
ML_EXIT_THRESHOLD_LONG = 0.75  # LONG exit threshold (optimized)
ML_EXIT_THRESHOLD_SHORT = 0.75  # SHORT exit threshold (optimized)
EMERGENCY_MAX_HOLD_TIME = 120  # 10 hours (10h × 60min / 5min = 120 candles)
...
# Load Exit Models (LATEST - Retrained with 2025-10-24 Entry Models)
print("Loading Exit models (PRODUCTION BASELINE - 20251023_212712)...")
...
if len(results_df) > 0:
    ...
    # Save results
    output_file = RESULTS_DIR / f"full_backtest_PRODUCTION_baseline_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
