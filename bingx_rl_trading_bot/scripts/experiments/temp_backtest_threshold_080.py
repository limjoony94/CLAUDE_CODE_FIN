...
Configuration:
  LONG Threshold: 0.80 (UPDATED 2025-10-25: Full backtest for monitoring metrics)
  SHORT Threshold: 0.80 (UPDATED 2025-10-25: Full backtest for monitoring metrics)
...
# Strategy Parameters
LEVERAGE = 4
LONG_THRESHOLD = 0.80  # PRODUCTION 2025-10-30: Current production setting
SHORT_THRESHOLD = 0.80  # PRODUCTION 2025-10-30: Current production setting
GATE_THRESHOLD = 0.001

# Exit Parameters (ML Exit + Emergency Safety Nets)
# ALIGNED 2025-10-27: Match training thresholds (Enhanced models trained with 0.75)
ML_EXIT_THRESHOLD_LONG = 0.75  # LONG exit threshold (matched to training)
ML_EXIT_THRESHOLD_SHORT = 0.75  # SHORT exit threshold (matched to training)
...
# Load Entry Models (PRODUCTION - Enhanced 5-Fold CV - 2025-10-24)
print("Loading Entry models (Enhanced 5-Fold CV - PRODUCTION - 20251024_012445)...")
import joblib
...
# Load Exit Models (PRODUCTION - oppgating_improved - 2025-10-24)
print("Loading Exit models (oppgating_improved - PRODUCTION - 20251024)...")
...
if len(results_df) > 0:
    ...
    # Save results
    output_file = RESULTS_DIR / f"full_backtest_OPTION_B_threshold_080_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
