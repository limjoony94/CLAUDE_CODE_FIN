"""
Validate 80/20 Split - ASYMMETRIC LABELING Models
==================================================

Backtest on 20% holdout data (6,001 candles, Oct 5-26)
to validate ASYMMETRIC labeling criteria models.

ASYMMETRIC LABELING:
  Entry: 1h minimum, 0.3% profit (captures opportunities)
  Exit: 2h minimum, 0.5% profit (confirms profits)
  Exit Threshold: 0.75 (labels already stricter: 47% vs 62% GOLDILOCKS)

Includes:
  - 0.10% round-trip trading fees (0.05% entry + 0.05% exit)
  - Realistic performance metrics
  - Comparison to baselines (Phase 2: -59.14%, Production: -59.48%)

Expected:
  - 5-20 trades/day (realistic frequency)
  - Positive return with fees
  - >80% ML Exit usage
...
ML_EXIT_THRESHOLD_LONG = 0.75  # ASYMMETRIC: Labels already stricter (47% vs 62%)
ML_EXIT_THRESHOLD_SHORT = 0.75  # ASYMMETRIC: Labels already stricter (47% vs 62%)
LEVERAGE = 4
...
print("="*80)
print("VALIDATION: 80/20 SPLIT - ASYMMETRIC LABELING (20% HOLDOUT)")
print("="*80)
print()
...
print(f"  ML Exit Threshold: LONG {ML_EXIT_THRESHOLD_LONG}, SHORT {ML_EXIT_THRESHOLD_SHORT} (Labels already stricter)")
