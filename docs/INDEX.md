...
> **Updated**: 2026-03-12 | **Bot Version**: v1.56.2
...
| 문서 | 설명 |
|------|------|
| [CLAUDE.md](../CLAUDE.md) | **프로젝트 핵심 문서** — 전략, 파라미터, 131패턴, 버전 히스토리 |

## docs/

| 문서 | 설명 |
|------|------|
| [VERSION_HISTORY.md](VERSION_HISTORY.md) | 전체 버전 히스토리 (v1.0~v1.56.2) + 연구 히스토리 |
...
| [v1.25.0-review.md](v1.25.0-review.md) | *(아카이브)* v1.25.0 Moderate-B-20 리뷰 |
...
| [CODE_AUDIT_2026_03_12.md](../bingx_rl_trading_bot/claudedocs/CODE_AUDIT_2026_03_12.md) | v1.56.2 코드 전수점검 (57건 검출, 7건 수정) |

## claudedocs/ (과거 연구 리포트 — 시점 스냅샷)

| 문서 | 설명 |
|------|------|
| COMPREHENSIVE_RESEARCH_REPORT_20260211.md | 종합 연구 리포트 (2026-02-11) |
...
| v1.33.0_pdca_report.md | v1.33.0 PDCA 리포트 |
| v1.34.0_pdca_report.md | v1.34.0 PDCA 리포트 |

## docs/archive/ (PDCA 문서)

| 위치 | 설명 |
|------|------|
| `docs/archive/2026-02/` | 2026-02 PDCA 문서 |
| `docs/archive/2026-03/pattern_5m/` | 2026-03 v1.55.0 PDCA cycle 문서 |
...
| scripts/analysis/README.md | 연구/분석 스크립트 가이드 |
| scripts/scanner/pattern_scanner.py | Dynamic WF Pattern Scanner CLI (v2.4, N-pos) |
